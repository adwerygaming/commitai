...
const { data: summaryData, error: summaryError, stats: summaryStats } = await (await GeminiService()).SummaryGitChanges({ gitDiffMessage: repoDiffContent, personality: SummaryPersonality });
