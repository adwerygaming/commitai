...
async function summaryWithAI(gitDiffMsg: string) {
    ...
    Rules & format:
    - Output only a JSON array of strings. Example: ["<subject>", "- <type>(<scope>): <short desc>", "- <type>(<scope>): <short desc>", "Generated by Google Gemini CLI"]
    ...
    - Append a final array element exactly: "Generated by Google Gemini CLI".
    - If the diff shows no changes, return ["No changes", "Generated by Google Gemini CLI"].
